...
export default function SonexDashboardPage() {
  ...
  return (
    <div data-tms-surface className="sonex-control-center min-h-full text-slate-900">
      <header className="sonex-control-header px-4 py-5 sm:px-6">
